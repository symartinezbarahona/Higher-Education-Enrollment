...
This project communicates important insights on county-level higher education enrollment rates in the U.S from 2016-2019. More specifically, it examines at changes in higher education enrollment rates between both years for the young adult population ages 18-34 and posits that these changes were in fact significant due to the massive shifts that occured in enrollment in certain regions of the country such as the American North and Southwest. Questions about these shifts definitely arose, but more data is needed to fully understand why these regions are seeing such drastic decreases. Additionally, a closer inspection of the State of Texas revealed that rural and suburban counties had the greatest decreases in enrollment in comparison to their urban counterparts. These discrepancies defintely gave us a clue as to what might be occurring (a massive influx of young people to urban centers particularly in the sunbelt), but again more data is needed to contextualize the full story. 
